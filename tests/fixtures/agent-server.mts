...
const app=await buildApp({db:await database(),demo:true,secret:'isolated-browser-agent-test-secret-32-characters',corsOrigin:'http://127.0.0.1:5175',agent:{apiKey:'test-only-key',transport:testTransport()}});
